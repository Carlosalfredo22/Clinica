...
function Header()
{
    ...
    $this->Cell(45,10,'Apellido', 1, 0, 'C' ,1);
    $this->Cell(95,10,'Email', 1, 1, 'C' ,1);
...
while($row = $resultado->fetch_assoc()){
 $pdf->Cell(10,10,$row['idusuario'], 1, 0, 'C' ,1);
 $pdf->Cell(45,10,$row['nombre'], 1, 0, 'C' ,1);
 $pdf->Cell(45,10,$row['apellido'], 1, 0, 'C' ,1);
 $pdf->MultiCell(95,10,$row['email'], 1, 'C' ,1);
}
